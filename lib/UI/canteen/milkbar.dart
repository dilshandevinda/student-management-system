...
class milkbar extends StatefulWidget {
  const milkbar({super.key});

  @override
  _Milkbar createState() => _Milkbar();
}

class _Milkbar extends State<milkbar> {
  ...
  _fetchFoodItems() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
          .collection('canteen')
          .where('canteenname', isEqualTo: 'Milkbar') // Changed canteen name
          .get();
