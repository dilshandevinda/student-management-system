...
class viharamahadevi extends StatefulWidget {
  const viharamahadevi({super.key});

  @override
  _ViharamahadeviCanteenState createState() => _ViharamahadeviCanteenState();
}

class _ViharamahadeviCanteenState extends State<viharamahadevi> {
  ...
  _fetchFoodItems() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
          .collection('canteen')
          .where('canteenname',
              isEqualTo: 'Viharamahadevi') // Changed canteen name
          .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text(
          'Viharamahadevi Hostel Canteen', // Changed canteen name
