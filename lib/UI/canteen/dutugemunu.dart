...
class dutugemunu extends StatefulWidget {
  const dutugemunu({super.key});

  @override
  _DutugemunuCanteenState createState() => _DutugemunuCanteenState();
}

class _DutugemunuCanteenState extends State<dutugemunu> {
  ...
  _fetchFoodItems() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
          .collection('canteen')
          .where('canteenname', isEqualTo: 'Dutugemunu')
          .get();
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              _fetchFoodItems(); // Call the function to refresh the data
            },
          ),
        ],
      ),
