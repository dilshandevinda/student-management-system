...
class technology extends StatefulWidget {
  ...
  @override
  _FacultyOfTechnologyCanteenState createState() =>
      _FacultyOfTechnologyCanteenState();
}

class _FacultyOfTechnologyCanteenState extends State<technology> {
  ...
  _fetchFoodItems() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
          .collection('canteen')
          .where('canteenname',
              isEqualTo: 'Faculty of Technology') // Changed canteen name
          .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text(
          'Faculty of Technology Canteen', // Changed page name & canteen name
